...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the descrypt field.
	 * @var        string
	 */
	protected $descrypt;
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::IMAGE;
		}
	...
	/**
	 * Set the value of [descrypt] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 */
	public function setDescrypt($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->descrypt !== $v) {
			$this->descrypt = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::DESCRYPT;
		}
	...
	public function setLevel($v)
	{
		...
		if ($this->level !== $v) {
			$this->level = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::LEVEL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->descrypt = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->level = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setDescrypt($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setLevel($arr[$keys[9]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::IMAGE)) $criteria->add(sfGuardUserProfilePeer::IMAGE, $this->image);
		if ($this->isColumnModified(sfGuardUserProfilePeer::DESCRYPT)) $criteria->add(sfGuardUserProfilePeer::DESCRYPT, $this->descrypt);
		if ($this->isColumnModified(sfGuardUserProfilePeer::LEVEL)) $criteria->add(sfGuardUserProfilePeer::LEVEL, $this->level);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDescrypt($this->descrypt);
