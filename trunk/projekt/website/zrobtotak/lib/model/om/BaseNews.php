...
abstract class BaseNews extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the text_des field.
	 * @var        string
	 */
	protected $text_des;
	...
	/**
	 * Get the [text_des] column value.
	 * 
	 * @return     string
	 */
	public function getTextDes()
	{
	...
	/**
	 * Set the value of [text_des] column.
	 * 
	 * @param      string $v new value
	 * @return     News The current object (for fluent API support)
	 */
	public function setTextDes($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->text_des !== $v) {
			$this->text_des = $v;
			$this->modifiedColumns[] = NewsPeer::TEXT_DES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->text_des = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 5; // 5 = NewsPeer::NUM_COLUMNS - NewsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setTextDes($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::TEXT_DES)) $criteria->add(NewsPeer::TEXT_DES, $this->text_des);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTextDes($this->text_des);
