...
abstract class BaseCategoriesPeer {
	...
	const IMAGE = 'categories.IMAGE';

	/** the column name for the CATEGORYUP_ID field */
	const CATEGORYUP_ID = 'categories.CATEGORYUP_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Slug', 'Description', 'Image', 'CategoryupId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'slug', 'description', 'image', 'categoryupId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SLUG, self::DESCRIPTION, self::IMAGE, self::CATEGORYUP_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'slug', 'description', 'image', 'categoryup_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Slug' => 2, 'Description' => 3, 'Image' => 4, 'CategoryupId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'slug' => 2, 'description' => 3, 'image' => 4, 'categoryupId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SLUG => 2, self::DESCRIPTION => 3, self::IMAGE => 4, self::CATEGORYUP_ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'slug' => 2, 'description' => 3, 'image' => 4, 'categoryup_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoriesPeer::SLUG);
		$criteria->addSelectColumn(CategoriesPeer::DESCRIPTION);
		$criteria->addSelectColumn(CategoriesPeer::IMAGE);
		$criteria->addSelectColumn(CategoriesPeer::CATEGORYUP_ID);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseCategoriesPeer', $criteria, $con);
		}
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CategoriesPeer::addSelectColumns($criteria);
		$startcol2 = (CategoriesPeer::NUM_COLUMNS - CategoriesPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoriesPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCategoriesPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoriesPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoriesPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCategoriesPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			CategoriesPeer::doOnDeleteSetNull(new Criteria(CategoriesPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			CategoriesPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// set fkey col in related Advice rows to NULL
			$selectCriteria = new Criteria(CategoriesPeer::DATABASE_NAME);
			$updateValues = new Criteria(CategoriesPeer::DATABASE_NAME);
			$selectCriteria->add(AdvicePeer::CATEGORY_ID, $obj->getId());
			$updateValues->add(AdvicePeer::CATEGORY_ID, null);
			...
			$selectCriteria = new Criteria(CategoriesPeer::DATABASE_NAME);
			$updateValues = new Criteria(CategoriesPeer::DATABASE_NAME);
			$selectCriteria->add(AdvicePeer::CATEGORY_UPCATEGORY_ID, $obj->getCategoryupId());
			$updateValues->add(AdvicePeer::CATEGORY_UPCATEGORY_ID, null);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCategoriesPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
