...
class NewsTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('TITLE', 'Title', 'VARCHAR', false, 400, null);
		$this->addColumn('CREATED_AT', 'CreatedAt', 'TIMESTAMP', false, null, null);
		$this->addColumn('TEXT_DES', 'TextDes', 'LONGVARCHAR', false, null, null);
		$this->addColumn('IMAGE', 'Image', 'VARCHAR', false, 400, null);
		// validators
	} // initialize()
