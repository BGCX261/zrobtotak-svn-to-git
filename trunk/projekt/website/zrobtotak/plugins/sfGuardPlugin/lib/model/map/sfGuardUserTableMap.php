...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('Comments', 'Comments', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'SET NULL', null);
    $this->addRelation('sfGuardUserProfile', 'sfGuardUserProfile', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('Advice', 'Advice', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
